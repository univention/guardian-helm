...
class TestExtraEnvVars(ExtraEnvVars):
    def adjust_values(self, values: dict):
        mapping = {
            "authorizationApi.extraEnvVars": "extraEnvVars",
            "managementApi.extraEnvVars": "extraEnvVars",
            "managementUi.extraEnvVars": "extraEnvVars",
            "openPolicyAgent.extraEnvVars": "extraEnvVars",
